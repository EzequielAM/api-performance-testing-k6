...
Every test execution monitors key system performance metrics out of the box:
Metric             Type            TargetSLA           Description                                                                                                                                                  
http_reqs          Counter            -                Total HTTP requests generated by the machine. 
http_req_duration  Trend           p(95) < 1500ms      End-to-end time for the server to respond.
...
Execution Evidence:(<img width="527" height="179" alt="image" src="https://github.com/user-attachments/assets/1dc9733b-69bf-425d-89ce-77d86ea7c0ea" />)default ✓ [======================================] 00/50 VUs  1m50s
